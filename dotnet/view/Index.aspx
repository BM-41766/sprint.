...
<body>
   <%  Using (Html.BeginForm())   %>
    ...
    <tr><td><input type="text" id="fname" placeholder="Firstname" onfocusout="datavalidate()" onclick="dvalidate()"/><input type="text" id="lname" placeholder="surname" onfocusout="lnamevalidate()" onclick="lastvalidate()"/></td></tr>
    <tr><td><input type="text" id="emal" placeholder="Email address or mobile number" onfocusout="emlvalidate()" onclick="emlvalidate()"/></td></tr>
    ...
    <tr><td><input type="password" id="paswrd"  placeholder="new password" onfocusout="paswrdvalidate()" onclick"pswrd()"/></td></tr>
